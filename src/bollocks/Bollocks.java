...
class Ball extends Group
{
    ...
    private double wall_bounciness = 0.65;      // 1 = perfect bounce, 0 = no bounce
    private int area_width = 0;
    private int area_height = 0;
    private double slowing_factor = 0.001;          // How much ball slows down every frame
...
public class Bollocks extends Application
{
    ...
    double velocity_boost = 3;

    AnimationTimer animation_timer ;
    
    public void handle_collisions(Ball a, Ball b)
    {
